...
public class Program {
    public static void Main(string[] args) {
        ...
        .ConfigureServices((services) => {
            ...
            services.AddSingleton<Core.IMessageHandler<Microsoft.Azure.SpaceFx.MessageFormats.HostServices.Position.PositionRequest>, MessageHandler<Microsoft.Azure.SpaceFx.MessageFormats.HostServices.Position.PositionRequest>>();
            services.AddSingleton<Core.IMessageHandler<Microsoft.Azure.SpaceFx.MessageFormats.HostServices.Position.PositionResponse>, MessageHandler<Microsoft.Azure.SpaceFx.MessageFormats.HostServices.Position.PositionResponse>>();
